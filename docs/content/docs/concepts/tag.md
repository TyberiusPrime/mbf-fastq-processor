...
- [LowercaseTag]({{< relref "docs/reference/modification-steps/LowercaseTag.md" >}}) – Lowercase the stored sequence (follow with [StoreTagInSequence]({{< relref "docs/reference/tag-steps/using/StoreTagInSequence.md" >}}) )
