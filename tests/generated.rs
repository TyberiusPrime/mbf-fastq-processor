...
fn test_case_demultiplex_simple_demultiplex_single_barcode_no_unmatched_output() {
    println!("Test case is in: test_cases/demultiplex/simple_demultiplex_single_barcode_no_unmatched_output");
...
fn test_case_extraction_edits_altering_tag_locations_cut_end_inside_tag() {
    println!("Test case is in: test_cases/extraction/edits_altering_tag_locations/cut_end_inside_tag");
...
fn test_case_extraction_edits_altering_tag_locations_cut_start_inside_tag() {
    println!("Test case is in: test_cases/extraction/edits_altering_tag_locations/cut_start_inside_tag");
...
fn test_case_extraction_edits_altering_tag_locations_extract_trim_end_false() {
    println!("Test case is in: test_cases/extraction/edits_altering_tag_locations/extract_trim_end_false");
...
fn test_case_extraction_edits_altering_tag_locations_extract_trim_end_true() {
    println!("Test case is in: test_cases/extraction/edits_altering_tag_locations/extract_trim_end_true");
...
fn test_case_extraction_edits_altering_tag_locations_extract_trim_start_false() {
    println!("Test case is in: test_cases/extraction/edits_altering_tag_locations/extract_trim_start_false");
...
fn test_case_extraction_edits_altering_tag_locations_extract_trim_start_true() {
    println!("Test case is in: test_cases/extraction/edits_altering_tag_locations/extract_trim_start_true");
...
fn test_case_extraction_edits_altering_tag_locations_max_len_after_tag() {
    println!("Test case is in: test_cases/extraction/edits_altering_tag_locations/max_len_after_tag");
...
fn test_case_extraction_edits_altering_tag_locations_max_len_before_tag() {
    println!("Test case is in: test_cases/extraction/edits_altering_tag_locations/max_len_before_tag");
...
fn test_case_extraction_edits_altering_tag_locations_max_len_inside_tag() {
    println!("Test case is in: test_cases/extraction/edits_altering_tag_locations/max_len_inside_tag");
...
fn test_case_extraction_edits_altering_tag_locations_trim_quality_start() {
    println!("Test case is in: test_cases/extraction/edits_altering_tag_locations/trim_quality_start");
...
fn test_case_extraction_extract_n_count_panic_on_store_in_seq() {
    ...
    run_test(std::path::Path::new("test_cases/extraction/extract_n_count_panic_on_store_in_seq"));
}
...
fn test_case_extraction_extract_n_count_simple_test() {
    ...
    run_test(std::path::Path::new("test_cases/extraction/extract_n_count_simple_test"));
}
...
fn test_case_extraction_extract_n_count_target_all_full_data() {
    ...
    run_test(std::path::Path::new("test_cases/extraction/extract_n_count_target_all_full_data"));
}
...
fn test_case_extraction_extract_n_count_target_all_read1_only() {
    ...
    run_test(std::path::Path::new("test_cases/extraction/extract_n_count_target_all_read1_only"));
}
...
fn test_case_extraction_store_tag_in_fastq_no_location() {
    ...
    run_test(std::path::Path::new("test_cases/extraction/store_tag_in_fastq/no_location"));
}
...
fn test_case_head_early_termination_multi_stage_head_report_middle_bottom() {
    println!("Test case is in: test_cases/head_early_termination/multi_stage_head_report_middle_bottom");
...
fn test_case_input_validation_extract_iupac_suffix_min_length_too_high() {
    println!("Test case is in: test_cases/input_validation/extract_iupac_suffix_min_length_too_high");
...
fn test_case_input_validation_extract_iupac_suffix_too_many_mismatches() {
    println!("Test case is in: test_cases/input_validation/extract_iupac_suffix_too_many_mismatches");
...
fn test_case_input_validation_input_file_is_output_file() {
    ...
    run_test(std::path::Path::new("test_cases/input_validation/input_file_is_output_file"));
}
...
fn test_case_input_validation_invalid_compression_levels_inspect_gzip_level_too_high() {
    println!("Test case is in: test_cases/input_validation/invalid_compression_levels/inspect_gzip_level_too_high");
...
fn test_case_input_validation_invalid_compression_levels_inspect_zstd_level_zero() {
    println!("Test case is in: test_cases/input_validation/invalid_compression_levels/inspect_zstd_level_zero");
...
fn test_case_input_validation_invalid_compression_levels_output_gzip_level_too_high() {
    println!("Test case is in: test_cases/input_validation/invalid_compression_levels/output_gzip_level_too_high");
...
fn test_case_input_validation_invalid_compression_levels_output_zstd_level_too_high() {
    println!("Test case is in: test_cases/input_validation/invalid_compression_levels/output_zstd_level_too_high");
...
fn test_case_input_validation_invalid_compression_levels_output_zstd_level_zero() {
    println!("Test case is in: test_cases/input_validation/invalid_compression_levels/output_zstd_level_zero");
...
fn test_case_input_validation_mismatched_seq_qual_len_1st_read_qual_too_long() {
    println!("Test case is in: test_cases/input_validation/mismatched_seq_qual_len_1st_read_qual_too_long");
...
fn test_case_input_validation_mismatched_seq_qual_len_1st_read_qual_too_short() {
    println!("Test case is in: test_cases/input_validation/mismatched_seq_qual_len_1st_read_qual_too_short");
...
fn test_case_input_validation_mismatched_seq_qual_len_2nd_read_qual_too_long() {
    println!("Test case is in: test_cases/input_validation/mismatched_seq_qual_len_2nd_read_qual_too_long");
...
fn test_case_input_validation_mismatched_seq_qual_len_2nd_read_qual_too_short() {
    println!("Test case is in: test_cases/input_validation/mismatched_seq_qual_len_2nd_read_qual_too_short");
...
fn test_case_input_validation_read_with_comment_in_line_3() {
    ...
    run_test(std::path::Path::new("test_cases/input_validation/read_with_comment_in_line_3"));
}
...
fn test_case_input_validation_unused_extract_tag() {
    ...
    run_test(std::path::Path::new("test_cases/input_validation/unused_extract_tag"));
}
...
fn test_case_input_validation_unwritable_output_dir() {
    ...
    run_test(std::path::Path::new("test_cases/input_validation/unwritable_output_dir"));
}
...
fn test_case_input_validation_windows_newlines() {
    ...
    run_test(std::path::Path::new("test_cases/input_validation/windows_newlines"));
}
...
fn test_case_integration_tests_cut_end_named_pipes() {
    ...
    run_test(std::path::Path::new("test_cases/integration_tests/cut_end_named_pipes"));
}
...
fn test_case_integration_tests_filter_other_file_by_name_remove_bam_unaligned_no_ignore() {
    println!("Test case is in: test_cases/integration_tests/filter_other_file_by_name_remove_bam_unaligned_no_ignore");
...
fn test_case_integration_tests_filter_other_file_by_seq_remove_bam_unaligned() {
    println!("Test case is in: test_cases/integration_tests/filter_other_file_by_seq_remove_bam_unaligned");
...
fn test_case_integration_tests_filter_other_file_by_seq_remove_bam_unaligned_no_ignore() {
    println!("Test case is in: test_cases/integration_tests/filter_other_file_by_seq_remove_bam_unaligned_no_ignore");
...
fn test_case_integration_tests_input_interleaved_test_premature_termination() {
    println!("Test case is in: test_cases/integration_tests/input_interleaved_test_premature_termination");
...
fn test_case_integration_tests_order_maintained_in_single_core_transforms() {
    println!("Test case is in: test_cases/integration_tests/order_maintained_in_single_core_transforms");
