...
fn test_case_extraction_extract_mean_quality_and_filter() {
    ...
    run_test(std::path::Path::new(
        "test_cases/extraction/extract_mean_quality_and_filter",
    ));
}

#[test]
fn test_case_extraction_extract_n_count_after_trim() {
...
#[test]
fn test_case_extraction_extract_n_count_panic_on_store_in_seq() {
...
#[test]
fn test_case_extraction_extract_n_count_simple_test() {
...
#[test]
fn test_case_extraction_extract_n_count_target_all_full_data() {
...
#[test]
fn test_case_extraction_extract_n_count_target_all_read1_only() {
...
#[test]
fn test_case_extraction_store_tag_in_fastq_no_location() {
...
#[test]
fn test_case_input_validation_bool_filter_wrong_tag_type() {
...
fn test_case_input_validation_cock_et_all_testdata_challenging_illumina_cat() {
    println!(
        "Test case is in: test_cases/input_validation/cock_et_all_testdata/challenging/illumina/cat"
    );
    run_test(std::path::Path::new(
        "test_cases/input_validation/cock_et_all_testdata/challenging/illumina/cat",
    ));
}
...
fn test_case_input_validation_cock_et_all_testdata_challenging_illumina_to_sanger() {
    println!(
        "Test case is in: test_cases/input_validation/cock_et_all_testdata/challenging/illumina/to_sanger"
    );
    run_test(std::path::Path::new(
        "test_cases/input_validation/cock_et_all_testdata/challenging/illumina/to_sanger",
    ));
}
...
fn test_case_input_validation_cock_et_all_testdata_challenging_illumina_to_solexa() {
    println!(
        "Test case is in: test_cases/input_validation/cock_et_all_testdata/challenging/illumina/to_solexa"
    );
    run_test(std::path::Path::new(
        "test_cases/input_validation/cock_et_all_testdata/challenging/illumina/to_solexa",
    ));
}
...
fn test_case_input_validation_cock_et_all_testdata_challenging_longreads_cat() {
    println!(
        "Test case is in: test_cases/input_validation/cock_et_all_testdata/challenging/longreads/cat"
    );
    run_test(std::path::Path::new(
        "test_cases/input_validation/cock_et_all_testdata/challenging/longreads/cat",
    ));
}
...
fn test_case_input_validation_cock_et_all_testdata_challenging_misc_dna_as_illumina() {
    println!(
        "Test case is in: test_cases/input_validation/cock_et_all_testdata/challenging/misc_dna/as_illumina"
    );
    run_test(std::path::Path::new(
        "test_cases/input_validation/cock_et_all_testdata/challenging/misc_dna/as_illumina",
    ));
}
...
fn test_case_input_validation_cock_et_all_testdata_challenging_misc_dna_as_solexa() {
    println!(
        "Test case is in: test_cases/input_validation/cock_et_all_testdata/challenging/misc_dna/as_solexa"
    );
    run_test(std::path::Path::new(
        "test_cases/input_validation/cock_et_all_testdata/challenging/misc_dna/as_solexa",
    ));
}
...
fn test_case_input_validation_cock_et_all_testdata_challenging_misc_dna_cat() {
    println!(
        "Test case is in: test_cases/input_validation/cock_et_all_testdata/challenging/misc_dna/cat"
    );
    run_test(std::path::Path::new(
        "test_cases/input_validation/cock_et_all_testdata/challenging/misc_dna/cat",
    ));
}
...
fn test_case_input_validation_cock_et_all_testdata_challenging_misc_rna_as_illumina() {
    println!(
        "Test case is in: test_cases/input_validation/cock_et_all_testdata/challenging/misc_rna/as_illumina"
    );
    run_test(std::path::Path::new(
        "test_cases/input_validation/cock_et_all_testdata/challenging/misc_rna/as_illumina",
    ));
}
...
fn test_case_input_validation_cock_et_all_testdata_challenging_misc_rna_as_solexa() {
    println!(
        "Test case is in: test_cases/input_validation/cock_et_all_testdata/challenging/misc_rna/as_solexa"
    );
    run_test(std::path::Path::new(
        "test_cases/input_validation/cock_et_all_testdata/challenging/misc_rna/as_solexa",
    ));
}
...
fn test_case_input_validation_cock_et_all_testdata_challenging_misc_rna_cat() {
    println!(
        "Test case is in: test_cases/input_validation/cock_et_all_testdata/challenging/misc_rna/cat"
    );
    run_test(std::path::Path::new(
        "test_cases/input_validation/cock_et_all_testdata/challenging/misc_rna/cat",
    ));
}
...
fn test_case_input_validation_cock_et_all_testdata_challenging_sanger_full_range_as_illumina() {
    println!(
        "Test case is in: test_cases/input_validation/cock_et_all_testdata/challenging/sanger_full_range/as_illumina"
    );
    run_test(std::path::Path::new(
        "test_cases/input_validation/cock_et_all_testdata/challenging/sanger_full_range/as_illumina",
    ));
}
...
fn test_case_input_validation_cock_et_all_testdata_challenging_sanger_full_range_as_solexa() {
    println!(
        "Test case is in: test_cases/input_validation/cock_et_all_testdata/challenging/sanger_full_range/as_solexa"
    );
    run_test(std::path::Path::new(
        "test_cases/input_validation/cock_et_all_testdata/challenging/sanger_full_range/as_solexa",
    ));
}
...
fn test_case_input_validation_cock_et_all_testdata_challenging_sanger_full_range_cat() {
    println!(
        "Test case is in: test_cases/input_validation/cock_et_all_testdata/challenging/sanger_full_range/cat"
    );
    run_test(std::path::Path::new(
        "test_cases/input_validation/cock_et_all_testdata/challenging/sanger_full_range/cat",
    ));
}
...
fn test_case_input_validation_cock_et_all_testdata_challenging_solexa_as_illumina() {
    println!(
        "Test case is in: test_cases/input_validation/cock_et_all_testdata/challenging/solexa/as_illumina"
    );
    run_test(std::path::Path::new(
        "test_cases/input_validation/cock_et_all_testdata/challenging/solexa/as_illumina",
    ));
}
...
fn test_case_input_validation_cock_et_all_testdata_challenging_solexa_as_sanger() {
    println!(
        "Test case is in: test_cases/input_validation/cock_et_all_testdata/challenging/solexa/as_sanger"
    );
    run_test(std::path::Path::new(
        "test_cases/input_validation/cock_et_all_testdata/challenging/solexa/as_sanger",
    ));
}
...
fn test_case_input_validation_cock_et_all_testdata_challenging_solexa_cat() {
    println!(
        "Test case is in: test_cases/input_validation/cock_et_all_testdata/challenging/solexa/cat"
    );
    run_test(std::path::Path::new(
        "test_cases/input_validation/cock_et_all_testdata/challenging/solexa/cat",
    ));
}
...
fn test_case_input_validation_cock_et_all_testdata_challenging_wrapping_cat() {
    println!(
        "Test case is in: test_cases/input_validation/cock_et_all_testdata/challenging/wrapping/cat"
    );
    run_test(std::path::Path::new(
        "test_cases/input_validation/cock_et_all_testdata/challenging/wrapping/cat",
    ));
}
...
fn test_case_input_validation_cock_et_all_testdata_reject_error_diff_ids() {
    println!(
        "Test case is in: test_cases/input_validation/cock_et_all_testdata/reject/error_diff_ids"
    );
    run_test(std::path::Path::new(
        "test_cases/input_validation/cock_et_all_testdata/reject/error_diff_ids",
    ));
}

#[test]
fn test_case_input_validation_cock_et_all_testdata_reject_error_double_qual() {
    println!(
        "Test case is in: test_cases/input_validation/cock_et_all_testdata/reject/error_double_qual"
    );
    run_test(std::path::Path::new(
        "test_cases/input_validation/cock_et_all_testdata/reject/error_double_qual",
    ));
}

#[test]
fn test_case_input_validation_cock_et_all_testdata_reject_error_double_seq() {
    println!(
        "Test case is in: test_cases/input_validation/cock_et_all_testdata/reject/error_double_seq"
    );
    run_test(std::path::Path::new(
        "test_cases/input_validation/cock_et_all_testdata/reject/error_double_seq",
    ));
}

#[test]
fn test_case_input_validation_cock_et_all_testdata_reject_error_long_qual() {
    println!(
        "Test case is in: test_cases/input_validation/cock_et_all_testdata/reject/error_long_qual"
    );
    run_test(std::path::Path::new(
        "test_cases/input_validation/cock_et_all_testdata/reject/error_long_qual",
    ));
}

#[test]
fn test_case_input_validation_cock_et_all_testdata_reject_error_no_qual() {
    println!(
        "Test case is in: test_cases/input_validation/cock_et_all_testdata/reject/error_no_qual"
    );
    run_test(std::path::Path::new(
        "test_cases/input_validation/cock_et_all_testdata/reject/error_no_qual",
    ));
}

#[test]
fn test_case_input_validation_cock_et_all_testdata_reject_error_qual_del() {
    println!(
        "Test case is in: test_cases/input_validation/cock_et_all_testdata/reject/error_qual_del"
    );
    run_test(std::path::Path::new(
        "test_cases/input_validation/cock_et_all_testdata/reject/error_qual_del",
    ));
}

#[test]
fn test_case_input_validation_cock_et_all_testdata_reject_error_qual_escape() {
    println!(
        "Test case is in: test_cases/input_validation/cock_et_all_testdata/reject/error_qual_escape"
    );
    run_test(std::path::Path::new(
        "test_cases/input_validation/cock_et_all_testdata/reject/error_qual_escape",
    ));
}

#[test]
fn test_case_input_validation_cock_et_all_testdata_reject_error_qual_null() {
    println!(
        "Test case is in: test_cases/input_validation/cock_et_all_testdata/reject/error_qual_null"
    );
    run_test(std::path::Path::new(
        "test_cases/input_validation/cock_et_all_testdata/reject/error_qual_null",
    ));
}

#[test]
fn test_case_input_validation_cock_et_all_testdata_reject_error_qual_space() {
    println!(
        "Test case is in: test_cases/input_validation/cock_et_all_testdata/reject/error_qual_space"
    );
    run_test(std::path::Path::new(
        "test_cases/input_validation/cock_et_all_testdata/reject/error_qual_space",
    ));
}

#[test]
fn test_case_input_validation_cock_et_all_testdata_reject_error_qual_tab() {
    println!(
        "Test case is in: test_cases/input_validation/cock_et_all_testdata/reject/error_qual_tab"
    );
    run_test(std::path::Path::new(
        "test_cases/input_validation/cock_et_all_testdata/reject/error_qual_tab",
    ));
}

#[test]
fn test_case_input_validation_cock_et_all_testdata_reject_error_qual_unit_sep() {
    println!(
        "Test case is in: test_cases/input_validation/cock_et_all_testdata/reject/error_qual_unit_sep"
    );
    run_test(std::path::Path::new(
        "test_cases/input_validation/cock_et_all_testdata/reject/error_qual_unit_sep",
    ));
}

#[test]
fn test_case_input_validation_cock_et_all_testdata_reject_error_qual_vtab() {
    println!(
        "Test case is in: test_cases/input_validation/cock_et_all_testdata/reject/error_qual_vtab"
    );
    run_test(std::path::Path::new(
        "test_cases/input_validation/cock_et_all_testdata/reject/error_qual_vtab",
    ));
}

#[test]
fn test_case_input_validation_cock_et_all_testdata_reject_error_short_qual() {
    println!(
        "Test case is in: test_cases/input_validation/cock_et_all_testdata/reject/error_short_qual"
    );
    run_test(std::path::Path::new(
        "test_cases/input_validation/cock_et_all_testdata/reject/error_short_qual",
    ));
}

#[test]
fn test_case_input_validation_cock_et_all_testdata_reject_error_spaces() {
    println!(
        "Test case is in: test_cases/input_validation/cock_et_all_testdata/reject/error_spaces"
    );
    run_test(std::path::Path::new(
        "test_cases/input_validation/cock_et_all_testdata/reject/error_spaces",
    ));
}

#[test]
fn test_case_input_validation_cock_et_all_testdata_reject_error_tabs() {
    println!("Test case is in: test_cases/input_validation/cock_et_all_testdata/reject/error_tabs");
    run_test(std::path::Path::new(
        "test_cases/input_validation/cock_et_all_testdata/reject/error_tabs",
    ));
}

#[test]
fn test_case_input_validation_cock_et_all_testdata_reject_error_trunc_at_plus() {
    println!(
        "Test case is in: test_cases/input_validation/cock_et_all_testdata/reject/error_trunc_at_plus"
    );
    run_test(std::path::Path::new(
        "test_cases/input_validation/cock_et_all_testdata/reject/error_trunc_at_plus",
    ));
}

#[test]
fn test_case_input_validation_cock_et_all_testdata_reject_error_trunc_at_qual() {
    println!(
        "Test case is in: test_cases/input_validation/cock_et_all_testdata/reject/error_trunc_at_qual"
    );
    run_test(std::path::Path::new(
        "test_cases/input_validation/cock_et_all_testdata/reject/error_trunc_at_qual",
    ));
}

#[test]
fn test_case_input_validation_cock_et_all_testdata_reject_error_trunc_at_seq() {
    println!(
        "Test case is in: test_cases/input_validation/cock_et_all_testdata/reject/error_trunc_at_seq"
    );
    run_test(std::path::Path::new(
        "test_cases/input_validation/cock_et_all_testdata/reject/error_trunc_at_seq",
    ));
}

#[test]
fn test_case_input_validation_cock_et_all_testdata_reject_error_trunc_in_plus() {
    println!(
        "Test case is in: test_cases/input_validation/cock_et_all_testdata/reject/error_trunc_in_plus"
    );
    run_test(std::path::Path::new(
        "test_cases/input_validation/cock_et_all_testdata/reject/error_trunc_in_plus",
    ));
}

#[test]
fn test_case_input_validation_cock_et_all_testdata_reject_error_trunc_in_qual() {
    println!(
        "Test case is in: test_cases/input_validation/cock_et_all_testdata/reject/error_trunc_in_qual"
    );
    run_test(std::path::Path::new(
        "test_cases/input_validation/cock_et_all_testdata/reject/error_trunc_in_qual",
    ));
}

#[test]
fn test_case_input_validation_cock_et_all_testdata_reject_error_trunc_in_seq() {
    println!(
        "Test case is in: test_cases/input_validation/cock_et_all_testdata/reject/error_trunc_in_seq"
    );
    run_test(std::path::Path::new(
        "test_cases/input_validation/cock_et_all_testdata/reject/error_trunc_in_seq",
    ));
}

#[test]
fn test_case_input_validation_cock_et_all_testdata_reject_error_trunc_in_title() {
    println!(
        "Test case is in: test_cases/input_validation/cock_et_all_testdata/reject/error_trunc_in_title"
    );
    run_test(std::path::Path::new(
        "test_cases/input_validation/cock_et_all_testdata/reject/error_trunc_in_title",
    ));
}
...
#[test]
fn test_case_input_validation_empty_output() {
...
#[test]
fn test_case_input_validation_input_file_is_output_file() {
...
#[test]
fn test_case_input_validation_read_with_comment_in_line_3() {
...
#[test]
fn test_case_input_validation_unused_extract_tag() {
...
#[test]
fn test_case_input_validation_unwritable_output_dir() {
...
#[test]
fn test_case_input_validation_windows_newlines() {
...
#[test]
fn test_case_integration_tests_cut_end_named_pipes() {
...
fn test_case_integration_tests_filter_avg_quality() {
    ...
    run_test(std::path::Path::new(
        "test_cases/integration_tests/filter_avg_quality",
    ));
}
...
#[test]
fn test_case_integration_tests_rename_read_index_placeholder() {
