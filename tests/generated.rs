...
fn test_cases_x_demultiplex_x_simple_demultiplex_iupac_two_regions() {
    ...
    run_test(std::path::Path::new("test_cases/demultiplex/simple_demultiplex_iupac_two_regions"));
}
...
fn test_cases_x_extraction_x_extract_iupac_with_indel() {
    ...
    run_test(std::path::Path::new("test_cases/extraction/extract_iupac_with_indel"));
}
...
fn test_cases_x_input_validation_x_empty_output() {
    ...
    run_test(std::path::Path::new("test_cases/input_validation/empty_output"));
}
...
fn test_cases_x_input_validation_x_no_output_no_reports_x_empty_output() {
    ...
    run_test(std::path::Path::new("test_cases/input_validation/no_output_no_reports/empty_output"));
}
...
fn test_cases_x_input_validation_x_no_output_no_reports_x_format_raw() {
    ...
    run_test(std::path::Path::new("test_cases/input_validation/no_output_no_reports/format_raw"));
}
...
fn test_cases_x_integration_tests_x_fastp_491() {
    ...
    run_test(std::path::Path::new("test_cases/integration_tests/fastp_491"));
}
...
fn test_cases_x_integration_tests_x_filter_other_file_by_name_distinct_separators() {
    println!("Test case is in: test_cases/integration_tests/filter_other_file_by_name_distinct_separators");
    run_test(std::path::Path::new("test_cases/integration_tests/filter_other_file_by_name_distinct_separators"));
}
...
fn test_cases_x_integration_tests_x_rename_read_index_placeholder() {
    ...
    run_test(std::path::Path::new("test_cases/integration_tests/rename_read_index_placeholder"));
}
